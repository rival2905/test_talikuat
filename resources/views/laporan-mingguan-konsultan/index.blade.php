        ...
        <div class="card-header p-3 fw-bold text-white" style="background: #1e3c72;">
            ...
            @if(!Auth::guard('external')->check())
                @if(Auth::user()->userDetail->role != 6 && Auth::user()->userDetail->role != 4)
                    <a href="{{route('laporan-mingguan-konsultan.create',$data->id)}}"
                        class="btn btn-warning btn-sm shadow-sm rounded-pill float-end"
                        data-bs-toggle="tooltip" title="Buat Laporan Mingguan">
                        Buat Laporan <i class="bx bxs-file-doc"></i>
                    </a>
                @endif
            @else
                <a href="{{route('laporan-mingguan-konsultan-external.create',$data->id)}}"
                    class="btn btn-warning btn-sm shadow-sm rounded-pill float-end"
                    data-bs-toggle="tooltip" title="Buat Laporan Mingguan">
                    Buat Laporan <i class="bx bxs-file-doc"></i>
                </a>
        ...
        <div class="card-body p-4">
            <div style="max-height:70vh; overflow-y:auto;">
                <table class="table table-striped table-hover align-middle text-center">
                    ...
                    <tbody>
                        @foreach($data->laporanKonsultan as $laporan)
                        <tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header" style="background:#1e3c72; color:white;">
                <h5 class="modal-title fw-bold" id="detailModalLabel">Detail Laporan Konsultan</h5>
            ...
            <div class="modal-body px-5">
                ...
                <h4 class="text-center fw-bolder fs-3 mt-4 mb-3">Detail Nomor Mata Pembayaran</h4>
            </div>
