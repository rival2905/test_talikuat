    ...
    <div class="card rounded-4 shadow-lg border-0 mb-4">
        <div class="card-header p-3 fw-bold text-white" style="background: #1e3c72;">
            ...
            <a href="{{ route('laporan-mingguan-uptd.create',$data->id) }}" 
               ...
               data-bs-toggle="tooltip" data-bs-placement="bottom" title="Buat Laporan Mingguan">
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body px-5">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Foto Laporan</label>
                    <div class="col-sm-10" id="fotoContainer"></div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label>Rencana</label>
