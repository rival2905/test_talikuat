            ...
            <div class="card-body">
                <div class="row align-items-start mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>UPTD</label>
                            <select name="uptd_id" class="form-select" disabled>
                ...
                <div class="row align-items-start mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="kategori_paket_id" required disabled>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nm_paket" id="nm_paket" value="{{$data_umum->nm_paket }}" class="form-control" required="" autocomplete="off" style="text-transform: uppercase" readonly />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Nilai Kontrak</label>
                            <input type="text" name="nilai_kontrak" id="nilaiKontrak" class="form-control" required value="{{ $data_umum->detail->nilai_kontrak }}" autocomplete="off" oninput="formatRupiah(this)" readonly />
                        </div>
                    </div>
                </div>
                <div class="row align-items-start mb-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_kontrak" value="{{ $data_umum->tgl_kontrak }}" id="tgl_kontrak" class="form-control" required readonly />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>No. Kontrak</label>
                            <input type="text" name="no_kontrak" id="no_kontrak" class="form-control" value="{{ $data_umum->no_kontrak }}" style="text-transform: uppercase" required readonly />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>No. SPMK</label>
                            <input type="text" name="no_spmk" id="no_spmk" value="{{ $data_umum->no_spmk }}" class="form-control" required autocomplete="off" style="text-transform: uppercase" readonly />
                        </div>
                    </div>
                </div>
                <div class="row align-items-start">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" name="tgl_spmk" id="tgl_spmk" value="{{ $data_umum->tgl_spmk }}" class="form-control valid" required aria-invalid="false" readonly />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Panjang KM</label>
                            <input type="number" step="0.01" name="panjang_km" value="{{ $data_umum->detail->panjang_km }}" id="panjang_km" class="form-control" required autocomplete="off" readonly />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Waktu Pelaksanaan</label>
                            <input type="number" step="1" value="{{ $data_umum->detail->lama_waktu }}" name="lama_waktu" id="lama_waktu" class="form-control" required="" autocomplete="off" readonly />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="mb-4 d-flex">
                        <div class="mr-2 w-50">
                            <select id="ruasJalan" required disabled>
                    ...
                    <table class="table table-bordered" id="tableRuas">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="segmen_jalan[]" value="{{$item->segment_jalan}}" autocomplete="off" placeholder="Km Bdg... s/d Km...Bdg" required readonly></td>
                                <td><input type="text" class="form-control" name="lat_awal[]" value="{{$item->lat_awal}}" autocomplete="off" placeholder="-7.123456" required readonly></td>
                                <td><input type="text" class="form-control" name="long_awal[]" value="{{$item->long_awal}}" autocomplete="off" placeholder="107.12345" required readonly></td>
                                <td><input type="text" class="form-control" name="lat_akhir[]" value="{{$item->lat_akhir}}" autocomplete="off" placeholder="-7.12345" required readonly></td>
                                <td><input type="text" class="form-control" name="long_akhir[]" value="{{$item->long_akhir}}" autocomplete="off" placeholder="107.12345" required readonly></td>
            ...
            <div class="card-body">
                <div class="row align-items-start mb-3">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="kontraktor_id" id="kontraktor_id" class="form-control" required disabled>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <select name="konsultan_id" id="konsultan_id" required disabled>
                ...
                <div class="row align-items-start">
                    <div class="col">
                        <div class="form-group">
                            <label>PPK</label>
                            <select name="ppk_user_id" id="ppk" class="form-control" required disabled>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="ppk_kegiatan" value="{{$data_umum->ppk_kegiatan}}" class="form-control" required readonly />
                        </div>
                    </div>
                </div>
            </div>
